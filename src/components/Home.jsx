                    ...
                    <div className="cards-flex">
                        <div className="card">
                            <a href="https://www.formula1.com/en/racing/2024/Monaco.html" target="_blank">
                                <div className="card-image">
                                    <img src="./public/img/circuitDeMonaco.jpg" alt="Circuit de Monaco" />
                        ...
                        <div className="card">
                            <a href="https://www.formula1.com/en/racing/2024/Great_Britain.html" target="_blank">
                                <div className="card-image">
                                    <img src="./public/img/circuitDeSilverstone.jpg" alt="Silverstone Circuit" />
                                    <div className="card-image-overlay">
                        ...
                        <div className="card">
                            <a href="https://www.formula1.com/en/racing/2024/Hungary.html" target="_blank">
                                <div className="card-image">
                                    <img src="./public/img/circuitDeHungaroring.jpg" alt="Hungaroring Circuit" />
                                    <div className="card-image-overlay">
                        ...
                        <div className="card">
                            <a href="https://www.formula1.com/en/racing/2024/Japan.html" target="_blank">
                                <div className="card-image">
                                    <img src="./public/img/circuitDeSuzuka.jpg" alt="Suzuka International Racing Course" />
                                    <div className="card-image-overlay">
                                        <span>Suzuka</span>
                                    </div>
                                </div>
